                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="select2 form-control block participants" name="participants" multiple="multiple" id="participants" style="width: 75%;margin-left:100px">
                                                            ...
                                                            while($row2=  mysqli_fetch_array($sql2)){
                                                               $campaign_participants_code=$row2['user_code'];
														   
														   
															
													echo	$q4= "select * from tbl_campaign_participants where campaign_id='$id' and campaign_participants_code='$campaign_participants_code'";
                                                            ...
                                                            $row3 = mysqli_fetch_array($q3);
                                                                ...
                                                                <option value="<?php echo $row2['user_code'] ?>"
                                                                     <?php if($row2['user_code'] == $row3['campaign_participants_code']){
                                                                         echo "selected";
                                                                     } ?>
                                                                       
                                                                       
                                                                        ><?php echo $row2['user_name']; ?>(<?php echo $row2['user_code']; ?>)</option>
                                                            <?php }   ?>

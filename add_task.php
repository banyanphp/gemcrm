                                        ...
                                        <div class="card-block">
                                            ...
                                            <form class="form form-horizontal" id="add_task_form" name="theform">
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group row" >
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" id="tname" class="form-control" placeholder="Task Name" name="tname" style="width:99%;">
                                                        </div>
                                                    </div>
                                            ...
                                            <div class=" col-md-9">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class=" col-md-9">
                                                            <textarea name='task' class="form-control" id="task" placeholder="Enter About task"></textarea>                                                           
                                                        </div>
                                                    </div>   

                ...
                <div class="card-body collapse in">
                    <div class="card-block card-dashboard">
                        ...
                        while($rows=mysqli_fetch_array($q)){
                        	...
                        	$prd_name	= 	$rows['product_group_name'];

										//product series name
                        $query = mysqli_query($conn,"SELECT  * FROM `tbl_product_tables` where product_group_id = '$prd_id'");
                        while($row=mysqli_fetch_array($query)){
                        	$id		= $row['product_group_id'];
                        	$nam		= $row['product_series_name'];
                        $tbl_name=$row['product_series_tbl_name'];
                        	
                        	$q2="select * from $tbl_name";
                        	
                        	$query2=mysqli_query($conn,"select * from $tbl_name");
                      ...
                      ?>
                                <tr>
                                    ...
                                    <td><a class="btn btn-success bnt-sm" href="product_edit.php?id=<?php echo $model;?>&series_name=<?php echo $nam; ?>">  <i class="icon-trash icon-small"></i>&nbsp; Edit</a></td>

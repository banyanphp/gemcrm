...
<tr>
	<th colspan="6" style="border: 1px solid black;padding: 0px">BILLING ADDRESS / SAME AS ABOVE</th>
</tr>
...
<tr>
	<th colspan="6" style="border: 1px solid black;padding: 0px">SHIP TO / CONSIGNEE / SAME AS ABOVE</th>
</tr>
<tr>
	<th colspan="2" style="text-align: left;border: 1px solid black;padding: 0px">ADDRESS LINE 1(*)</th>
...
<table style="width: 800px;border: 1px solid black;border-collapse: collapse;padding: 3px">
  <tr>
    <th colspan="9" style="border: 1px solid black;border-collapse: collapse;padding: 3px">PRODUCT DETAILS</th>
  </tr>
  <tr>
...
$rs=mysqli_fetch_array($sqls)	;		 
  ?>
	...
	<td style="border: 1px solid black;border-collapse: collapse;padding: 3px"><?php echo $r['enq_product_price']; ?></td>
...
<table style="width: 800px;border: 1px solid black;border-collapse: collapse;padding: 3px">
 ...
 <table style="width: 800px;border: 1px solid black;border-collapse: collapse;padding: 3px">
  ...
  <tr>
	...
	<td colspan="4" style="border: 1px solid black;border-collapse: collapse;padding: 3px"><?php echo $payment_termss; ?></td>
	<td colspan="4" style="border: 1px solid black;border-collapse: collapse;padding: 3px">CREDIT DAYS:<?php echo $dayss; ?></td>
  </tr>
  <tr>
...
<tr>
	<th style="border: 1px solid black;border-collapse: collapse;padding: 3px">PREPARED BY:KARTHIK</th>

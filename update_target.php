...
<?php
$id=$_REQUEST['id'];
 $sqlyear                         = "select target_id,	target_year,target_amount,target_dryer,target_chiller,target_cooler,target_var,target_small_products,target_enquiry,target_campaign from tbl_target where target_id='$id'";
	                    ...
	                    <form class="form form-horizontal" id="add_target">
	                    	<div class="form-body">
			                    ...
			                    <div class="form-group row">
	                            	<label class="col-md-3 label-control" for="projectinput1">Year</label>
		                            <div class="col-md-9">
		                            	<input type="text" id="year" disabled class="form-control" placeholder="Enter Year" name="year" value="<?php echo $target_year; ?>">
		                            </div>
		                        </div>
		                        <div class="form-group row">
	                            	<label class="col-md-3 label-control" for="projectinput2">Enter Amount</label>
									<div class="col-md-9">
	                            		<input type="text" id="amt" class="form-control" placeholder="Enter amount" name="amt" value="<?php echo $target_amount; ?>">
	                            	</div>
		                        </div>
		                        <div class="form-group row">
		                            <label class="col-md-3 label-control" for="projectinput3">Dryer</label>
		                            <div class="col-md-9">
		                            	<input type="text" id="dryerqty" class="form-control" placeholder="Dryer Qty" name="Dryer" value="<?php echo $target_dryer; ?>">
		                            </div>
		                        </div>
		                        ...
		                        <div class="form-group row">
		                            ...
		                            <div class="col-md-9">
		                            	<input type="text" id="chillerqty" class="form-control" placeholder="Chiller Qty" name="Chiller" value="<?php echo $target_chiller; ?>">
		                            </div>
		                        </div>
		                        ...
		                        <div class="form-group row">
									...
									<div class="col-md-9">
		                            	<input type="text" id="coolerqty" class="form-control" placeholder="Cooler Qty" name="Cooler" value="<?php echo $target_cooler; ?>">
		                            </div>
		                        </div>
		                        ...
		                        <div class="form-group row">
									...
									<div class="col-md-9">
		                            	<input type="text" id="target_varqty" class="form-control" placeholder="Enter Var Products" name="varproducts" value="<?php echo $target_var; ?>">
		                            </div>
		                        </div>
								 <div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Small Products </label>
									<div class="col-md-9">
		                            	<input type="text" id="smallqty" class="form-control" placeholder="Enter Small Products " name="smallproducts" value="<?php echo $target_small_products; ?>">
		                            </div>
		                        </div>
 <div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Enquiry </label>
									<div class="col-md-9">
		                            	<input type="text" id="enquiry" class="form-control" placeholder="Enquiry" name="enquiry" value="<?php echo $target_enquiry; ?>">
		                            </div>
		                        </div>
<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Campaign </label>
									<div class="col-md-9">
		                            	<input type="text" id="campaign" class="form-control" placeholder="Campaign" name="Campaign" value="<?php echo $target_campaign; ?>">
		                            </div>
		                        </div>
							<input type="hidden" id="target_id" class="form-control" placeholder="Campaign" name="id" value="<?php echo $year_id; ?>">	 <div class="form-group col-md-12" style="text-align:center">		
...
<!-- // Basic form layout section end -->
    ...
    <script src="robust-assets/js/components/target/update_target_button.js"></script>
    <!-- BEGIN VENDOR JS-->

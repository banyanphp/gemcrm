                ...
                <div class="card-body collapse in">
                    <div class="card-block card-dashboard">
                        <table class="table table-striped table-bordered file-export">
							...
							$s=mysqli_query($conn,"select * from tbl_enquiry where enq_status='Process' ");
							...
							?>
                                <tr>
                                    ...
                                    <td> <a href="test3.php?id=<?php echo $row['enq_id'];?>" class="btn btn-info"><i class="icon-pencil2"></i></a></td>

...
$st_ex = mysqli_query($conn,"select * from tbl_team where team_id = '$id'");
$row=mysqli_fetch_array($st_ex);
 $code=$row['team_head_user_code'];
 ?>		
                                    ...
                                    <div class="card-body collapse in">
                                        <div class="card-block">
                                            ...
                                            <form class="form form-horizontal" id="add_team_form" name="theform">
                                                <div class="form-body">
                                                    <h4 class="form-section"><i class="icon-head"></i> Edit Team</h4>
                                                    <div class="form-group row" >
                                                        <label class="col-md-3 label-control" > Name</label>
                                                        <div class="col-md-9">
                                                            <input type="text" id="cname" value="<?php echo $row['team_name'];?>" class="form-control" placeholder="Name" name="fname" style="width:99%;">
                                                        </div>
                                                    </div>
<div class="form-group row" >
                                                        <label class="col-md-3 label-control" > Discount</label>
                                                        <div class="col-md-9">
                                                            <input type="text" id="discount" value="<?php echo $row['team_discount'];?>" class="form-control" placeholder="discount" name="discount" style="width:99%;">
                                                        </div>
                                                    </div>
                                            ...
                                            <div class=" col-md-9">
                                                        <select class="form-control"  name="team" id="team">
														  ...
														  ?>
                                                                <option value="<?php echo $rows['user_code'] ?>" <?php if($rows['user_code']==$code){echo "Selected";} ?>><?php echo $rows['user_name']; ?>(<?php echo $rows['user_code']; ?>)</option>
														  <?php } ?>
														</select>
													...
													<div class="form-group row" >
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="email" id="tl_mail" value="<?php echo $row['team_mail']; ?>" class="form-control" placeholder="E-mail" name="tl_mail" style="width:99%;">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="select2 form-control block participants" name="participants" multiple="multiple" id="participants" style="width: 75%;margin-left:100px">
                                                            ...
                                                            <?php
                                                            $qt = mysqli_query($conn,"select * from tbl_user");
                                                            while ($rowt = mysqli_fetch_array($qt)) {
                                                                print_r($rowt);

?>

                                                                <option value="<?php echo $rowt['user_code'] ?>" <?php 
																$qs = mysqli_query($conn,"select * from tbl_team_members where team_id=$id");

                                                            while ($rowq = mysqli_fetch_array($qs)) {
																if($rowq['members_code']==$rowt['user_code']){
																	echo "selected";
																}
															}
																
																 ?> ><?php echo $rowt['user_name']; ?>(<?php echo $rowt['user_code']; ?>)</option>
															<?php } ?>


                                                        </select>
                                                    </div>  
                                                            <input type="hidden" id="t_id" value="<?php echo $row['team_id']; ?>" class="form-control" placeholder="E-mail" name="tl_mail" style="width:99%;">
        ...
        <script src="robust-assets/js/components/team/update.js"></script>
        <!-- END PAGE VENDOR JS-->
        <!-- BEGIN ROBUST JS-->

                                            ...
                                            <table class="table table-striped table-bordered file-export">
                                                ...
                                                <tbody>
                                                    ...
                                                    while ($row = mysqli_fetch_array($q)) {
                                                        ...
                                                        $name3 = '';
                                                        $ids = $row['team_id'];
                                                        $team_head = $row['team_head_user_code'];
                                                        $q2 = mysqli_query($conn, "select * from tbl_user where user_code=$team_head");
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo $row2['user_name']; ?>(<?php echo $row2['user_code']; ?>)</td>
                                                            <td><?php echo $row['team_discount']; ?></td>


                                                            <td><?php
                                                                $q1 = "select * from tbl_team_members where `team_id`='$ids'";
                                                                $r = mysqli_query($conn, $q1);
                                                                while ($row = mysqli_fetch_array($r)) {
                                                                    $code.=$row['members_code'];
                                                                    $code.=",";
                                                                }
                                                                ...
                                                                echo $name3;
                                                                ?></td>
																<td><button type="button"  onclick="window.location.href='update_team.php?id=<?php echo $ids;?>'" class="btn btn-success"><i class="icon-pencil"></i></button>
                                    						  <button type="button" onclick="deleteteam(<?php echo $ids;?>)" class="delete btn btn-danger"><i class="icon-trash"></i></button></td>

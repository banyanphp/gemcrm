                    ...
                    <div class="card-block card-dashboard">
                        <table class="table table-striped table-bordered file-export">
							...
							include 'dbconnect.php';
							 $q=mysqli_query($conn,"select * from tbl_task where task_status='1'");
							...
							?>
								...
								$username=$row['task_assigned_to']; 
                                    ...
                                    <td> <a href="view_complete_report_task_list.php?id=<?php echo $row['task_id'];?>" class="btn btn-info">View</a></td>

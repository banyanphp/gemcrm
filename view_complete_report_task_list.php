...
<html lang="en" data-textdirection="LTR" class="loading">
    ...
    <body data-open="click" data-menu="vertical-menu" data-col="2-columns" class="vertical-layout vertical-menu 2-columns  fixed-navbar">
        ...
        <?php include 'header.php';
								...
								$id=$_GET['id'];
							 $qs=mysqli_query($conn,"select * from tbl_task where task_id='$id'and task_status='1'");
...
<div class="form-group row" >
                                                        <label class="col-md-3 label-control" >Task Created ON</label>
                                                        <div class="col-md-9">
                                                            <input type="text" id="tname" class="form-control" disabled Value="<?php echo $rows['task_created_on'];?>" name="tname" style="width:99%;">
                                                        </div>
                                                    </div>
													<div class="form-group row" >
                                                        <label class="col-md-3 label-control" > Task Closed On</label>
                                                        <div class="col-md-9">
                                                            <input type="text" id="tname" class="form-control" disabled Value="<?php echo $rows['task_created_on'];?>" name="tname" style="width:99%;">
                                                        </div>
                                                    </div>
                                            ...
                                            <div class=" col-md-9">
														  ...
														  <?php 
														  include 'dbconnect.php';
														  $q=mysqli_query($conn,"select * from tbl_user where user_code='$user'");
														$row=mysqli_fetch_array($q); ?>
														
													 <input type="text" id="tname" disabled class="form-control"  Value="<?php echo $row['user_name']; ?>(<?php echo $row['user_code']; ?>)" name="tname" style="width:99%;">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class=" col-md-9">
                                                            <textarea name='task' disabled class="form-control" id="task" placeholder="Enter About task"><?php echo $rows['task_about'];?></textarea>                                                           
                                                        </div>
                                                    </div>   
  ...
  <div class="form-group row">
                                                        ...
                                                        <div class=" col-md-9">
                                                            <textarea name='report' disabled class="form-control" id="report"><?php echo $rows['task_report_description'];?></textarea>                                                           
                                                        </div>
                                                    </div>   
        ...
        <script src="robust-assets/js/components/task/addtask.js"></script>
        <!-- END PAGE VENDOR JS-->
        <!-- BEGIN ROBUST JS-->

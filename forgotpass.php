	...
	<div class="card border-grey border-lighten-3 px-2 py-2 row mb-0">
		...
		<div class="card-body collapse in">
			<div class="card-block">
				<form class="form-horizontal" action="snd_mail.php" name="forgot_pass_form" id="forgot_pass_form" method="POST">
					...
					<button type="submit" class="btn btn-danger btn-block btn-lg" id="forgot_passwdes" name='forgot_passwdes'>

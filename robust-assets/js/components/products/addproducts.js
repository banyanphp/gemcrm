$(function() {
    $("#product_submit").click(function() {
        ...
        if (gem == 'HLD') {
            ...
            var hld_wrkngpres = $("#hld_wrkngpres").val();
        ...
        if (gem == 'RAD') {
            ...
            if (rad_descrp == '') {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'add_products_proccess.php?action=RAD',
                    data: {
            ...
            if (cht_nexlh_descrp == '') {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        cht_lh_sapcode: cht_nexlh_sapcode,
        ...
        if (gem == 'GZF CATRIDGES') {
            ...
            var gzf_sapcode = $("#gzfcat_sapcode").val();
            ...
            var gzf_descrp = $("#gzfcat_descrp").val();
        ...
        if (gem == 'GZF') {
            ...
            var g_sapcode = $("#gzff_sapcode").val();
        ...
        //GFV
        if (gem == 'GFV') {
            var gzf_prd_model = $("#gfv_prd_model").val();
            var gzf_sapcode = $("#gzf_sapcode").val();
            var gzf_prc = $("#gzf_prc").val();
            var gzf_valveopen = $("#gzf_valveopen").val();
            var gz_valvedischrg = $("#gz_valvedischrg").val();
            var gzf_pwrcon = $("#gzf_pwrrcon").val();
            var gzf_max_temp = $("#gzf_max_temp").val();
            var gzf_max_oper = $("#gzf_max_oper").val();
            var gzf_inout_port = $("#gzf_inout_port").val();
            var gzf_warranty_doc = $("#gzf_warranty_doc").val();

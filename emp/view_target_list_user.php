...
$total='';
										  ...
										  <?php
										  if($r=='dryer'){
											 $q33=mysqli_fetch_array(mysqli_query($conn,"select sum(`enq_product_qty`) as count from tbl_enquiry where enq_status='Completed' and enq_product_series='1' and enq_year_id='$yid' and 	enq_month_id='$mid' and enq_alloted_to='$name2'"));
											if($q33['count']!=''){
													 echo $q33['count'];
											}
											else{
										   ...
										   if($r=='chiller'){
											 $q33=mysqli_fetch_array(mysqli_query($conn,"select sum(`enq_product_qty`) as count from tbl_enquiry where enq_status='Completed' and enq_product_series='2'and enq_year_id='$yid' and 	enq_month_id='$mid' and enq_alloted_to='$name2'"));
											 if($q33['count']!=''){
													 echo $q33['count'];
											}
											else{
										   ...
										   if($r=='cooler'){
											 $q33=mysqli_fetch_array(mysqli_query($conn,"select sum(`enq_product_qty`) as count from tbl_enquiry where enq_status='Completed' and enq_product_series='3' and enq_year_id='$yid' and 	enq_month_id='$mid' and  enq_alloted_to='$name2'"));
											if($q33['count']!=''){
													 echo $q33['count'];
											}
											else{
										   ...
										   if($r=='var'){
											 $q33=mysqli_fetch_array(mysqli_query($conn,"select sum(`enq_product_qty`) as count from tbl_enquiry where enq_status='Completed' and enq_product_series='4'and enq_year_id='$yid'and 	enq_month_id='$mid' and  enq_alloted_to='$name2'"));
											if($q33['count']!=''){
													 echo $q33['count'];
											}
											else{
										  ...
										  if($r=='small_products'){
											 $q33=mysqli_fetch_array(mysqli_query($conn,"select sum(`enq_product_qty`) as count from tbl_enquiry where enq_status='Completed' and enq_product_series='5' and enq_year_id='$yid'and 	enq_month_id='$mid' and  enq_alloted_to='$name2'"));
											if($q33['count']!=''){
													 echo $q33['count'];
											}
											else{

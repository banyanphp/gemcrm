                                                ...
                                                <div id="entry1" class="clonedInput">      
                                                    ...
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-9">
                                                                <select id="enq_product" name="enq_product[]" class="form-control input_fn" onchange="getmodel(this.value, $(this).attr('id'))">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-9" id="hide">
                                                                <select id="enq_model"  name="enq_model[]" class="form-control input_ln" onchange="getmodelno(this.value, $(this).attr('id'))">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-9" id="hide-modelno">
                                                                <select id="enq_model_no" name="enq_model_no[]" class="form-control input_gn" onchange="gettype(this.value, $(this).attr('id'))">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-9" id="hide-type">
                                                                <select id="enq_type" name="enq_type[]" class="form-control input_mn"  onchange="getprice(this.value, $(this).attr('id'))">
                                                                    <option value="0">Select Model First</option>
                                                        ...
                                                        <div class="form-group row" id="price">
                                                            ...
                                                            <div class="col-md-9">
                                                                ...
                                                                <input type="text"  disabled name="price[]" id="prices" class="form-control input_price" value="">
                                                                <input type="hidden" value="" id="qprice" name="qprice[]"  class="form-control input_price_hn">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-2">
                                                                ...
                                                                <div class="input-group">
                                                                    <input type="text" class="form-control input_qn" name="enq_qty[]" value="1" id="enq_qty" onchange="getgroupprice($(this).attr('id'))">
                                                                </div>

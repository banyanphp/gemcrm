                    ...
                    <div class="card-block card-dashboard">
                        <table class="table table-striped table-bordered file-export">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>Southern Cooling Towers Pvt. Ltd.</td>
                                    <td>Chiller</td>
                                    <td>test</td>
                                    <td>9876543210</td>
                                ...
                                <tr>
                                    <td>Paltech Cooling Tower & Equipments Limited</td>
                                    <td>Chiller</td>
                                    <td>test</td>
                                    <td>9876543210</td>
                                    <td>kolkata</td>      <td>12-03-2017</td>
                                </tr>
                                <tr>
                                    <td>flamingochillers</td>
                                    <td>Dryer</td>
                                    <td>test</td>
                                    <td>9876543210</td>
                                    <td>pune</td>     <td>2-04-2017</td>
                                </tr>
                                <tr>
                                    <td>Reynold India Pvt Ltd</td>
                                    <td>Cooler </td>
                                    <td>test</td>
                                    <td>9876543210</td>
                                    <td>trippur</td>     <td>3-04-2017</td>

                                </tr>
                                <tr>
                                    <td>Kirloskar Chillers Private Limited</td>
                                    <td>Cooler</td>
                                    <td>test</td>
                                    <td>9876543210</td>
                                    <td>madurai</td>

                ...
                <div class="card-body collapse in">
                    <div class="card-block card-dashboard">
                        <table class="table table-striped table-bordered file-export">
							...
							$s=mysqli_query($conn,"select * from tbl_enquiry where enq_status='Completed' and enq_alloted_to='$user_code'");
							...
							?>
                                <tr>
                                    ...
                                    <td><button type="button"  onclick="window.location.href='details.php?id=<?php echo $row['enq_no'];?>'" class="btn btn-success">Follow Up Details</button></td>

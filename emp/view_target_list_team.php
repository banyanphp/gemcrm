...
$total='';
  ...
  <td>
										  ...
										  if($r=='dryer'){
										   ...
										   if($r=='cooler'){
											 $q33=mysqli_fetch_array(mysqli_query($conn,"select sum(`enq_product_qty`) as count from tbl_enquiry where enq_status='Completed' and enq_product_series='3' and enq_year_id='$yid' and 	enq_month_id='$mid' and  enq_alloted_to='$name2'")); echo $q33['count'];
										  }
										   if($r=='var'){

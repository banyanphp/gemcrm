...
<input type="hidden" value="<?php echo $id;?>" name="id">
                                             <div class="form-group row">
                                            <label class="col-md-3 label-control">Task Assigned By</label>
                                            <div class=" col-md-9">
                                             
                                                            <input type="text" id="tname" class="form-control" disabled Value="<?php if($rows['task_assigned_by']=='admin'){ ECHO "admin";}
															
															else{
																$assign=$rows['task_assigned_by'];
																$q="select * from tbl_user where user_code='$assign'";
																$res=mysqli_query($conn,$q);
																$row=mysqli_fetch_array($res);
																echo $row['user_name'];
															}
															?>" name="tname" style="width:99%;">
                                                        </div>          

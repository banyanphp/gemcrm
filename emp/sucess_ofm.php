                ...
                <div class="card-body collapse in">
                    <div class="card-block card-dashboard">
                        <table class="table table-striped table-bordered file-export">
							...
							$s=mysqli_query($conn,"select * from tbl_enquiry where enq_status='Completed' and ofm_id!=''");
							while($row=mysqli_fetch_array($s)){
								$ids=$row['enq_id'];
$nos1=$row['ofm_id'];
$y="select * from tbl_ofm where ofm_id='$nos1'";
$st=mysqli_fetch_array(mysqli_query($conn,$y));
$nos=$st['ofm_enqiry_number'];
							?>
                                <tr>
                                    ...
                                    <td><button type="button"  onclick="window.location.href='details.php?id=<?php echo $eno;?>'" class="btn btn-success" title="Follow Ups"><i class="icon-paper-clip"></i></button>
<button type="button"  onclick="window.location.href='ofm_view.php?ofms_id=<?php echo $nos;?>'" class="btn btn-primary btn-sm">View Ofm</button>
</td>

...
$is=$_SESSION['user_id'];
$t="select user_image from tbl_user where user_id=$is";
$Q=mysqli_fetch_array(mysqli_query($conn,"$t"));
$img=$Q['user_image'];
 ?>
    <!-- navbar-fixed-top-->
    <!-- navbar-fixed-top-->
...
margin-top: 10px;">+ ADD</button></a>
                ...
                <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                  <li class="dropdown-menu-header">
                    <h6 class="dropdown-header m-0">Appointment	<span class="notification-tag tag tag-default tag-danger float-xs-right m-0"></span></h6>
                  </li>
			  ...
			  <?php
			$dats = date('Y-m-d');
					 $val=mysqli_query($conn,"SELECT * FROM `tbl_task` WHERE `task_status`='0' AND `task_assigned_to`='$usr'");
                ...
                <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                  ...
                  <li class="list-group scrollable-container">
				  <?php 
					$task=mysqli_query($conn,"SELECT * FROM `tbl_task` WHERE `task_status`='0' AND `task_assigned_to`='$usr'");
				  ...
				  <a href="javascript:void(0)" class="list-group-item">
                      <div class="media">
						...
						<i></i></span></div>
                        <div class="media-body">
                          <h6 class="media-heading">Task Name:<?php echo $res['task_name']; ?></h6>
                          <p class="notification-text font-small-3 text-muted">Task Created By:<?php echo $res['task_assigned_by']; ?></p><small>
                            <time datetime="2015-06-11T18:29:20+08:00" class="media-meta text-muted">About:<?php echo $res['task_about']; ?></time></small>
                        </div>
                      </div></a>
					  <?php } ?>
					  </li>
              ...
              <li class="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link"><span class="avatar avatar-online"><img src="../executive/<?php echo $img; ?>" alt="avatar"><i></i></span><span class="user-name">Admin</span></a>
    ...
    <div id="main-menu" data-scroll-to-active="true" class="main-menu menu-dark menu-fixed menu-shadow menu-accordion">
      ...
      <div class="main-menu-content">
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
          ...
          <li class=" nav-item"><a href="#"><i class="icon-paper"></i><span data-i18n="nav.templates.main" class="menu-title">Enquiry</span></a>
            <ul class="menu-content">
              ...
              <li><a href="list_Scheduling.php" data-i18n="nav.page_headers.headers_breadcrumbs_top" class="menu-item"> Pending Enquiries</a>
			  <li><a href="new_scheduling.php" data-i18n="nav.page_headers.headers_breadcrumbs_top" class="menu-item">Process Enquiries</a>
              </li>
              </li> 	  <li><a href="sucessleads.php" data-i18n="nav.page_headers.headers_breadcrumbs_top" class="menu-item">Successful Enquiry</a>
			  <ul class="menu-content">
              ...
              </li<li><a href="negativeleads.php" data-i18n="nav.page_headers.headers_breadcrumbs_top" class="menu-item">Negative  Enquiries</a>
              </li>
       ...
       <li class=" nav-item"><a href="#"><i class="ficon icon-mail6"></i><span data-i18n="nav.templates.main" class="menu-title">Task </span></a>
            <ul class="menu-content">
        
                  <li><a href="task_list.php" data-i18n="nav.templates.vert.classic_menu" class="menu-item">My Task</a>
                  </li>
        ...
        <li class=" nav-item"><a href="#"><i class="icon-target"></i><span data-i18n="nav.page_headers.main" class="menu-title">Target</span></a>
            <ul class="menu-content">
              ...
              <li><a href="target_list_user.php" data-i18n="nav.page_headers.headers_breadcrumbs_top" class="menu-item">Target List</a>
              </li>
          ...
          <li class=" nav-item"><a href="index.php"><i class="icon-power3"></i><span data-i18n="nav.footers.main" class="menu-title">Log Out</span></a>

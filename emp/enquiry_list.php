...
<section id="file-export">
    <div class="row">
		...
		$team_id=$get_team['team_id'];
							...
							$s=mysqli_query($conn,"select * from tbl_enquiry where enq_status='New'and enq_team_id='$team_id'");
							...
							?>
                                <tr>
                                    ...
                                    <td><button type="button"  onclick="window.location.href='view_enquiry.php?id=<?php echo $ids;?>'" class="btn btn-success"><i class="icon-pencil"></i></button>
						  <button type="button" onclick="deleteenquiry(<?php echo $ids;?>)" class="delete btn btn-danger"><i class="icon-trash"></i></button></td>

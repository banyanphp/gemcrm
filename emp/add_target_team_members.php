...
<h4 class="form-section"><i class="icon-head"></i>Hari</h4>
 <div class="form-group row">
	                            	<label class="col-md-3 label-control" for="projectinput2">Amount(in Cr)</label>
									<div class="col-md-8">
...
<h4 class="form-section"><i class="icon-head"></i>Ramesh</h4>
 <div class="form-group row">
	                            	<label class="col-md-3 label-control" for="projectinput2">Amount(in Cr)</label>
									<div class="col-md-8">
	                            		<input type="text"  id="projectinput2" class="form-control" placeholder="Enter amount" name="year" Value="Rs. ">
...
<h4 class="form-section"><i class="icon-head"></i>Rahul</h4>
 <div class="form-group row">
	                            	<label class="col-md-3 label-control" for="projectinput2">Amount(in Cr)</label>
									<div class="col-md-8">
	                            		<input type="text"  id="projectinput2" class="form-control" placeholder="Enter amount" name="year" Value="Rs.">
...
<h4 class="form-section"><i class="icon-head"></i>Prabha</h4>
 <div class="form-group row">
	                            	<label class="col-md-3 label-control" for="projectinput2">Amount(in Cr)</label>
									<div class="col-md-8">
	                            		<input type="text"  id="projectinput2" class="form-control" placeholder="Enter amount" name="year" Value="Rs.">

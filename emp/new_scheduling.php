                ...
                <div class="card-body collapse in">
                    <div class="card-block card-dashboard">
                        <table class="table table-striped table-bordered file-export">
                            ...
                            <?php 
							include 'dbconnect.php';$user_code=$_SESSION['user_code'];
							$s=mysqli_query($conn,"select * from tbl_enquiry where enq_status='Process' and enq_alloted_to='$user_code'");
							while($row=mysqli_fetch_array($s)){
								$ids=$row['enq_id'];
							?>
                                <tr>
								
                                    <td><?php  echo $eno=$row['enq_no']?></td>
                                    ...
                                    <td><button type="button"  onclick="window.location.href='details.php?id=<?php echo $eno;?>'" class="btn btn-success" title="Follow Ups"><i class="icon-paper-clip"></i></button>
                                     <a href="test3.php?id=<?php echo $row['enq_id'];?>" class="btn btn-info"><i class="icon-pencil2"></i></a></td>

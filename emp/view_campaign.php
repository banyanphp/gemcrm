                                            ...
                                            <form class="form form-horizontal" id="add_campaign_form" name="theform">
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group row" >
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" id="cname" class="form-control" value="<?php echo $cname; ?>" name="fname" style="width:99%;" disabled>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row" >
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" id="cplace" class="form-control" value="<?php echo $campaign_place; ?>" name="Place" style="width:99%;"disabled>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row" >
                                                        ...
                                                        <div class="col-md-9">
                                                            <textarea name="description" disabled id="description" class="form-control"><?php echo $campaign_description; ?></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card-body collapse in">
                                                        <div class="card-block form-group row">
                                                            ...
                                                            <label class="col-md-3 label-control" disabled for="projectinput9" style="padding-left: 0px;padding-right: 31px;">Date</label>
                                                            <div class="col-md-9" style="padding-left: 0px;"><div class='input-group'>
                                                                    <input type='text' disabled placeholder="date" class="form-control daterange" id="from" name="date"  value="<?php echo $cdate; ?>"/>

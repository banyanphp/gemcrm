                ...
                <div class="card-body collapse in">
                    <div class="card-block card-dashboard">
                        <table class="table table-striped table-bordered file-export">
							...
							$s=mysqli_query($conn,"select * from tbl_enquiry where enq_status='Pending' and enq_alloted_to='$user_code'");
							...
							?>
                                <tr>
                                    ...
                                    <td> <a href="test2.php?id=<?php echo $row['enq_id'];?>" class="btn btn-info"><i class="icon-pencil2"></i></a></td>

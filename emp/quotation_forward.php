...
if($_REQUEST['cemail1']!=''){
   $recipients[] = $_REQUEST['cemail1'];
}

if($_REQUEST['cemail2']!=''){
   $recipients[] = $_REQUEST['cemail2'];
}
...
file_get_contents('http://hpsms.dial4sms.com/api/web2sms.php?username=mmvcbe&password=happy1234&to='.$cphone.'&sender=GEMEQP&message='.$message1.'');		
		 ...
		 echo "<script>alert('Quotation Forwarded Successfully')</script>";
		 echo "<script>window.location.href='quotation_follow.php?id=".$quation_id."'</script>";
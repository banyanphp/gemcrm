        ...
        <div class="card border-grey border-lighten-3 m-0">
            ...
            <div class="card-body collapse in">
                <div class="card-block">
                    <form class="form-horizontal form-simple" action="home.php" method="post" novalidate id="login-form">
                        <fieldset class="form-group has-feedback has-icon-left mb-0">
                            <input type="text" class="form-control form-control-lg input-lg" name="code" id="user-name" placeholder="Your Employee Code" required>

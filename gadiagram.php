                ...
                <div class="card-body collapse in">
                    <div class="card-block card-dashboard">
                            ...
                            <tbody>
									...
									<?php 
	$sql=mysqli_query($conn,"SELECT * FROM `tbl_type_price`");
	while($res=mysqli_fetch_array($sql)){
		$model_no = $res['type_price_model'];
		$model_pric = $res['type_price_model_no'];
		$model_ga = $res['ga_diagram'];
?>
          
                                <tr>
                                    <td><?php echo $model_no; ?></td> 
                                                        <td><?php echo $model_pric; ?></td> 
                                                        <td><a href="http://gemservice.in/crm/gadiagrams/<?php echo $model_ga; ?>" target="_blank"><?php echo $model_ga; ?></a></td> 
                                                        <td> 
															<a href="upload_ga.php?id=<?php echo $model_pric; ?>" class="btn btn-success" style="color:white;">Upload</a>
														</td>

...
$total='';
                                                    ...
                                                    $q = mysqli_query($conn, "select * from tbl_target_team where  team_target_id='$id'");
...
$tid=$row['team_id'];
 ...
 $sqlamount= "SELECT enq_quotation  FROM `tbl_enquiry` where enq_status='Completed' and enq_product_series='1' and enq_year_id='$yid' and 	enq_month_id='$mid' and  enq_team_id='$tid'";
$totaldryerqty="0"; 
$totalchillerqty="0"; 
$totalcoolerqty="0"; 
$totalsmallqty="0"; 
...
$totaldryerqty+=$dryerqty['totalqty'];
										   ...
										   if($r=='chiller'){
											$sqlamount= "SELECT enq_quotation  FROM `tbl_enquiry` where enq_status='Completed' and enq_product_series='1' and enq_year_id='$yid' and 	enq_month_id='$mid' and  enq_team_id='$id'";
$totaldryerqty="0"; 
$totalchillerqty="0"; 
$totalcoolerqty="0"; 
$totalsmallqty="0"; 
...
$totalchillerqty+=$dryerqty['totalqty'];
										   ...
										   if($r=='cooler'){
											$sqlamount= "SELECT enq_quotation  FROM `tbl_enquiry` where enq_status='Completed' and enq_product_series='1' and enq_year_id='$id' and 	enq_month_id='$mid' and  enq_team_id='$tid'";
$totaldryerqty="0"; 
$totalchillerqty="0"; 
$totalcoolerqty="0"; 
$totalsmallqty="0"; 
...
$totalcoolerqty+=$dryerqty['totalqty'];
}
...
$totalvarqty+=$dryerqty['totalqty'];
										  ...
										  if($r=='enquiry'){
											  $q33=mysqli_fetch_array(mysqli_query($conn,"select count(`enq_product_qty`) as count from tbl_enquiry where enq_year_id='$yid' and enq_month_id='$mid' and  enq_team_id='$tid'"));
											 	if($q33['count']!=''){
													 echo $q33['count'];
											}
											else{
										    ...
										    if($r=='campaign'){
											  $q33=mysqli_fetch_array(mysqli_query($conn,"select count(`campaign_id`) as count from tbl_campaign where campaign_year_id='$yid'and campaign_month_id='$mid' and campaign_team_id='$tid'"));
											 	if($q33['count']!=''){
													 echo $q33['count'];
											}
											else{
    ...
    <?php }
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        ...
                                                        <th>Fixed Target:(<?php echo $total; ?>)Qty</th>
                                                        <th>Achieved Target(<?php echo "0"; ?>)Qty</th>
                                                    </tr>
                                                </tfoot>
                                            </table>
                                        </div>

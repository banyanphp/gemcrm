...
<html lang="en" data-textdirection="LTR" class="loading">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body collapse in">
                                        <div class="card-block">
                                            ...
                                            <form class="form form-horizontal" id="sales-registration" action="#" enctype="multipart/form-data">
                                                <div class="form-body">
  ...
  <div class="form-group row">
                                                    <label class="col-md-3 label-control" for="projectinput7">Choose Image</label>
                                                    <div class="col-md-9">

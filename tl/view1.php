                                    ...
                                    <div class="card-body collapse in">
                                        <div class="card-block">
                                            ...
                                            <form class="form form-horizontal">
                                                <div class="form-body">
                                                    <h4 class="form-section"><i class="icon-head"></i> Schedule Details</h4>
                                                    ...
                                                    <div class="form-group row">
                            <label class ="col-md-3 label-control"> Appointment On</label>
                            <div class="input-group col-md-9" style="margin-top: -10px;width: 75%;">
                                <span class="input-group-addon"><i class="icon-calendar3"></i></span>
                                <input type="text" id="test" name="date"  class="form-control datepicker-default col-md-9" style="" />
                            </div>
...
<div class="form-actions" style="float:right;">
        ...
        <!-- END PAGE VENDOR JS-->
        <!-- BEGIN ROBUST JS-->
        <script src="robust-assets/js/app.min.js"></script>      <script src="robust-assets/js/core/libraries/jquery_ui/jquery-ui.min.js" type="text/javascript"></script>

 ...
 <?php
                                            ...
                                            ?>
											   ...
											   if($_SESSION['user_permsission_self_allotment']=='yes'&& $_SESSION['user_permsission_alotment']!='yes'){
												 ...
												 <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="checkbox"  id="allotment" class="" name="allotedto" value="<?php echo $_SESSION['team_head_user_code']; ?>">Self Allotment
                                                        ...
                                                        <select  class="form-control" name="allotedto" id="participants">
														  <option selected="selected" value="0">Select</option>
															...
															$team_id=$_SESSION['team_id'];
															 $qq="select * from tbl_team_members where team_id=$team_id";
                                                            $q = mysqli_query($conn,$qq);
                                                            while ($row = mysqli_fetch_array($q)) {
																$campaign_participants_code=$row['members_code'];
                                    ...
                                    $row2= mysqli_fetch_array($r2);
                                     $name3=$row2['user_name'];
                                                                ...
                                                                <option value="<?php echo $row['members_code'] ?>"><?php echo $name3; ?>(<?php echo $row['members_code']; ?>)</option>
<?php } ?>
 ...
 <div class="col-md-12" style="text-align:center">
        ...
        <script src="robust-assets/js/components/enquiry/allots.js" type="text/javascript"></script>

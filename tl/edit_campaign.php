                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body collapse in">
                                        <div class="card-block">
                                            ...
                                            <form class="form form-horizontal" id="edit_campaign_form" name="theform">
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <?php 
                                                         $q2="select * from tbl_campaign_participants where campaign_id='$id'"; 
                                                        $sql2=mysqli_query($conn, $q2);
														$isd=$_SESSION['team_id'];
														echo $q222= "select * from tbl_team_members where team_id='$isd'";
														 $q22=mysqli_query($conn,$q222);?>
                                                        <select class="select2 form-control block participants" name="participants" multiple="multiple" id="participants" style="width: 75%;margin-left:100px">
                                                            ...
                                                            while($row2=  mysqli_fetch_array($sql2)){
															  ...
															  while($row33=mysqli_fetch_array($q22)){
															echo  $c=$row33['members_code'];echo "1222";
                                                            $q3 = mysqli_query($conn,"select * from tbl_user where user_code='$c'");
                                                            while ($row3 = mysqli_fetch_array($q3)) {
                                                                ?>       



                                                                <option value="<?php echo $row3['user_code'] ?>"
                                                                     <?php if($row2['campaign_participants_code'] == $row3['user_code']){
                                                                         echo "selected";
                                                                     } ?>
                                                                       
                                                                       
                                                                        ><?php echo $row3['user_name']; ?>(<?php echo $row3['user_code']; ?>)</option>
                                                            <?php } } }?>
                                                    ...
                                                    <div class="form-actions" style="float:right;">
                                                        ...
                                                        <button type="button" class="btn btn-primary" id="edit_campaign">
...
(function (root, factory) {
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        if (this.element.is('input') && !this.singleDatePicker && this.autoUpdateInput) {
          //  this.element.val(this.startDate.format(this.locale.format) + this.locale.separator + this.endDate.format(this.locale.format));
                                          this.element.val('<?php echo $cdate1; ?>'+ this.locale.separator + '<?php echo $cdate2; ?>');
    ...
    DateRangePicker.prototype = {
        ...
        updateFormInputs: function() {
            ...
            this.container.find('input[name=daterangepicker_start]').val('<?php echo $cdate1; ?>');
            if (this.endDate)
                this.container.find('input[name=daterangepicker_end]').val('<?php echo $cdate2; ?>');
    ...
    return DateRangePicker;
        ...
        <script src="robust-assets/js/components/campaign/edit_campaign.js"></script>
        <!-- END PAGE VENDOR JS-->
        <!-- BEGIN ROBUST JS-->
...
! function(a, b, c) {
    ...
    var d = c("#picker_from").pickadate(''),
        e = d.pickadate("picker"),
        f = c("#picker_to").pickadate(''),

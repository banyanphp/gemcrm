...
<html lang="en" data-textdirection="LTR" class="loading">
  <head>
    ...
    <meta name="description" content="sales based crm">
    <meta name="keywords" content="sales based crm,crm">
    <meta name="author" content="thebanyaninfotech">
    <title>Login Page - GemCrm</title>
        ...
        <div class="card border-grey border-lighten-3 m-0">
            <div class="card-header no-border">
                <div class="card-title text-xs-center">
                    <div class="p-1"><img src="robust-assets/images/logo/gem.png" alt="branding logo"></div>
                </div>
                <h6 class="card-subtitle line-on-side text-muted text-xs-center font-small-3 pt-2"><span>Login with Gem</span></h6>
            </div>
            <div class="card-body collapse in">
                <div class="card-block">
                    <form class="form-horizontal form-simple" id="login-form" method="post" novalidate>
                        <fieldset class="form-group has-feedback has-icon-left mb-0">
                            <input type="text" class="form-control form-control-lg input-lg" name="email" id="user-name" placeholder="Your Username" required>
                        ...
                        <fieldset class="form-group row">
                            ...
                            <div class="col-md-6 col-xs-12 text-xs-center text-md-right"><a href="forgotpass.php" class="card-link">Forgot Password?</a></div>
                        </fieldset>
						<span id="errors" style="color:#ff0000"></span>
                        <button type="button" class="btn btn-primary btn-lg btn-block" id="login_button"><i class="icon-unlock2"></i> Login</button>
                    </form>
                </div>
            </div>

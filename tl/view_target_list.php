                            ...
                            <div class="col-xs-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title">Team Target List</h4>
...
$total='';
                                                    ...
                                                    $q = mysqli_query($conn, "select * from tbl_target_team where team_id='$id' and month_id='$current_month' ");
										  ...
										  <?php
										  if($r=='dryer'){
											 $q33=mysqli_fetch_array(mysqli_query($conn,"select sum(`enq_product_qty`) as count from tbl_enquiry where enq_status='Completed' and enq_product_series='1' and enq_year_id='$id' and 	enq_month_id='$mid' and  enq_team_id='$id'"));
											if($q33['count']!=''){
													 echo $q33['count'];
											}
											else{
										   ...
										   if($r=='chiller'){
											 $q33=mysqli_fetch_array(mysqli_query($conn,"select sum(`enq_product_qty`) as count from tbl_enquiry where enq_status='Completed' and enq_product_series='2'and enq_year_id='$id' and 	enq_month_id='$mid' and  enq_team_id='$id'"));
											if($q33['count']!=''){
													 echo $q33['count'];
											}
											else{
										   ...
										   if($r=='cooler'){
											 $q33=mysqli_fetch_array(mysqli_query($conn,"select sum(`enq_product_qty`) as count from tbl_enquiry where enq_status='Completed' and enq_product_series='3' and enq_year_id='$id' and 	enq_month_id='$mid' and  enq_team_id='$id'"));
											 if($q33['count']!=''){
													 echo $q33['count'];
											}
											else{
										   ...
										   if($r=='var'){
											 $q33=mysqli_fetch_array(mysqli_query($conn,"select sum(`enq_product_qty`) as count from tbl_enquiry where enq_status='Completed' and enq_product_series='4'and enq_year_id='$id'and 	enq_month_id='$mid' and  enq_team_id='$id'"));
											if($q33['count']!=''){
													 echo $q33['count'];
											}
											else{
										  ...
										  if($r=='small_products'){
											 $q33=mysqli_fetch_array(mysqli_query($conn,"select sum(`enq_product_qty`) as count from tbl_enquiry where enq_status='Completed' and enq_product_series='5' and enq_year_id='$id'and 	enq_month_id='$mid' and  enq_team_id='$id'"));
											if($q33['count']!=''){
													 echo $q33['count'];
											}
											else{
										  ...
										  if($r=='enquiry'){
											  $q33=mysqli_fetch_array(mysqli_query($conn,"select count(`enq_product_qty`) as count from tbl_enquiry where enq_status='Completed'and enq_year_id='$id' and enq_month_id='$mid' and  enq_team_id='$id'"));
											if($q33['count']!=''){
													 echo $q33['count'];
											}
											else{
										    ...
										    if($r=='campaign'){
											  $q33=mysqli_fetch_array(mysqli_query($conn,"select count(`campaign_id`) as count from tbl_campaign where campaign_year_id='$id'and campaign_month_id='$mid' and campaign_team_id='$id'"));
if($q33['count']!=''){
													 echo $q33['count'];
											}
											else{
    ...
    <?php }
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        ...
                                                        <th>Fixed Target:(<?php echo $total; ?>)</th>
                                                        <th>Achieved Target(<?php echo "0"; ?>)</th>
                                                    </tr>
                                                </tfoot>
                                            </table>
                                        </div>

...
$user_code=$_SESSION['team_head_user_code'];
							$s=mysqli_query($conn,"select * from tbl_enquiry where enq_status='Completed'and checked_by='$user_code'");
...
<button type="button"  onclick="window.location.href='ofm_view.php?ofms_id=<?php echo $no;?>'" class="btn btn-primary btn-sm">View OFM</button></td>
</td>

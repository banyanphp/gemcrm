        ...
        <div class="col-xs-12">
            <div class="card">
                ...
                <div class="card-body collapse in">
					...
					<form method="POST" id="reports-gen" action='user_reports_team.php'>
					 <div class="form-group row col-md-12">
							 ...
							 <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <select id="enq_user" name="id" class="form-control">
                                                                <option value="0">Select User</option>
                                                                 <?php
                                                                $q3 = mysqli_query($conn, "select members_code from tbl_team_members where team_id=7");
                                                                while ($row = mysqli_fetch_array($q3)) {
																	$name2=$row['members_code'];
...
<button type="submit" class="btn btn-primary" id="enq_reg">
                                                         Export AS excel
                                                    </button>
                                                </div>

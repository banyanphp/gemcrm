                            ...
                            <div class="col-xs-12">
                                <div class="card">
                                   ...
                                   ?></td>
                                                          ...
                                                          <td>Rs.<?php $total=mysqli_fetch_array(mysqli_query($conn,"SELECT sum(`enq_product_price`) as total FROM `tbl_enquiry` where enq_team_id='$id'"));
									echo $total['total'];
									?></td>
                                                            <td> <a href="view_target_list.php?id=<?php echo $row['team_id']; ?>" class="btn btn-info"><i class="icon-eye"></i></a>
                                                            </td>

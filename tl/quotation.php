...
$enq_product_group= $res['enq_product_group'];
						...
						?>
<?php if($enq_product_group!=2){ ?>
<img style='padding:10px' src='http://gemservice.in/crm/logo.jpg' alt='gem' >
...
<?php  }  else { ?>
				...
				<ul class="px-0 list-unstyled">
					<li class="text-bold-800">GEM ORION MACHINERY PRIVATE LIMITED,</li>
					<li>SF.NO. 100/2A, AVINASHI RAOD, ARASUR,</li>
					<li>COIMBATORE – 641 407.</li>
...
echo $row['description'];						 
		...
		<p style="font-size:14px;color:#000;">
		 Packaging & Forwarding Tax &nbsp; : &nbsp; <?php echo $tax;  ?> %<br><br>
 ...
 <p style="font-size:14px;color:#000;"> Erection &nbsp; &nbsp; &nbsp;: 0.00</p>
	...
	<!--	<p style="font-size:14px;color:#000;"> GST &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; : 0.00%</p>-->
		...
		<p style="font-size:14px;color:#000;"> GEM EQUIPMENTS(P)LTD </p>
			<p style="font-size:14px;color:#000;"> <br/></p>
			 <?php  $q21="select * from tbl_user where `user_code`='$user_code'";
		...
		<div id="invoice-footer">
			<div class="row">
				<div class="col-md-12 col-sm-12 text-xs-center">
					<button type="button" class="btn btn-primary btn-lg my-1" id="" onclick="window.location.href='send_mail.php?id=<?php echo $quation_id; ?>'"><i class="icon-paperplane" ></i> Send Quotation</button><br><br>

                ...
                <div class="card-body">
                    <div class="card-block">
                        <div class="options">
                            ...
                            <hr>
                            <div class="row">
							<form class="form form-horizontal" id="appointment_submit_form" method="POST"><br>
                                <div class="form-group row">
	                            	<label class="col-md-3 label-control" for="projectinput1">Appointment Date :</label>
		                            <div class="col-md-9">
                                <input type="text" id="appoint_date" name="appoint_date" class="form-control datepicker-default" />
                            </div>
		                            </div>
								...
								<div class="form-group row">
		                            ...
		                            <div class="col-md-9">
		                        <input type="text" class="form-control" id="autoswitch" placeholder="Select Your Appointment Time" name="appoint_tme">	
		                            </div>
		                        </div>
								<div class="form-group row">
	                            	<label class="col-md-3 label-control" for="projectinput1">Appointment Company Name :</label>
		                            <div class="col-md-9">
		                        <input type="text" class="form-control" id="appoint_Cmpny" placeholder="Appointment Company Name" name="appoint_Cmpny">	
		                            </div>
		                        </div>
								<!--<div class="form-group row">
	                            	<label class="col-md-3 label-control" for="projectinput2">Appointment User code :</label>
									<div class="col-md-9">
	                            		<input type="text"  id="" class="form-control" placeholder="Enter Appointment User code" name="appoint_usrcode">
	                            	</div>
		                        </div>-->
								<div class="form-group row">
	                            	<label class="col-md-3 label-control" for="projectinput2">Appointment With :</label>
									<div class="col-md-9">
	                            		<input type="text"  id="appoint_usrnam" class="form-control" placeholder="Enter Appointment With	" name="appoint_usrnam">
	                            	</div>
		                        </div>
								<div class="form-group row">
	                            	<label class="col-md-3 label-control" for="projectinput2">Appointment Through :</label>
									<div class="col-md-9">
                            <input type="text" class="form-control" data-toggle="tooltip" data-trigger="hover" data-placement="top" placeholder="Enter Appointment Through" data-title="(Ex: Phone,skype,video call,direct)" data-original-title="" title="" name="appoint_thrugh" id="appoint_thrugh">
	                            	</div>
		                        </div>
								<div class="form-group row">
	                            	<label class="col-md-3 label-control" for="projectinput2">Appointment Location :</label>
									<div class="col-md-9">
	                            		<input type="text"  id="appoint_locatn" class="form-control" placeholder="Enter Appointment Location" name="appoint_locatn">
	                            	</div>
		                        </div>
								<div class="form-group row">
	                            ...
	                            <button type="submit" class="btn btn-primary" name="submit" id="appointment_submit">
...
<script src="robust-assets/js/vendors.min.js"></script>
    ...
    <!-- BEGIN PAGE LEVEL JS-->
    <script src="robust-assets/js/components/ui/jquery-ui/date-pickers.js" type="text/javascript"></script>
    <script src="robust-assets/js/components/pickers/appointment.js" type="text/javascript"></script>

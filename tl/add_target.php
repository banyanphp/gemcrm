	                    ...
	                    <form class="form form-horizontal" id="add_target">
	                    	<div class="form-body">
			                    ...
			                    <div class="form-group row">
		                            ...
		                            <div class="col-md-9">
		                            	<input type="text" id="year" class="form-control" placeholder="Enter Year" name="year">
		                            </div>
		                        </div>
		                        <div class="form-group row">
	                            	<label class="col-md-3 label-control" for="projectinput2">Enter Amount(in Cr)</label>
									<div class="col-md-9">
	                            		<input type="text" id="amt" class="form-control" placeholder="Enter amount" name="amt" Value="Rs. ">
	                            	</div>
		                        </div>
		                        <div class="form-group row">
...
<!-- // Basic form layout section end -->
    ...
    <script src="robust-assets/js/components/target/target_button.js"></script>
    <!-- BEGIN VENDOR JS-->

...
$user_code=$_SESSION['team_id'];							$s=mysqli_query($conn,"select * from tbl_enquiry where enq_status='Dropped' and enq_team_id='$user_code'");
							...
							?>
                                <tr>
                                    ...
                                    <td><button type="button"  onclick="window.location.href='details.php?id=<?php echo $row['enq_no'];?>'" class="btn btn-success">Follow up Details</button>
						 </td>

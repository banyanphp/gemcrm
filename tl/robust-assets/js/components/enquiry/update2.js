$(function () {
    $("#enq_update_form").on("submit", (function(g) {
        ...
        if (cemail != '') {
         ...
         if (enq_pin == '') 
			  ...
			  if (status== '') 
		  {
			...
			if (status == 'New Quotation' || status=='Another Quotation') {
		 ...
		 if (enq_model6 == '') 
			...
			if (qty6 == '') 
		  {
		    ...
		    return false;
			  ...
			  $.ajax({
                type: 'POST',
                url: 'update_enquiry_process2.php',
...
$("#errors").html("Error Occured ");
					 ...
					 setTimeout(function () {
                        $('#success').html('');
												window.location.href='new_scheduling.php';
				...
				if(status=="Completed"){
					var shows_quotation_list = $("#shows_quotation_list").val();
					var file = $("#file").val();
if (shows_quotation_list=='0') 
		  {
			  $('#errors').html('Please Select Quotation');
                $("#shows_quotation_list").focus();
		    return false;
            }
if (file=='') 
		  {
			     $("#errors").html("Please upload File");
            $("#file").focus();
            return false
            }
                ...
                success: function (response) {
					alert(response);
                    if (response == 1) {
                        $("#success").html("Enquiry Completed Successfully");
						 setTimeout(function () {
                        $('#success').html('');
												window.location.href='sucessleads.php';

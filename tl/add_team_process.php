...
$sql = "INSERT INTO `tbl_team`(`team_id`, `team_name`, `team_head_user_code`, `team_password`, `team_discount`, `team_created_on`, `team_last_login_on`, `team_status`)  VALUES"
        . " ('','$cname','$team','$password','$discount','$dates','','1')";

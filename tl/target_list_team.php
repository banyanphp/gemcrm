                    ...
                    <div class="card-block card-dashboard">
                        <table class="table table-striped table-bordered file-export">
                            ...
                            <tbody>
							  ...
							  $month=date("n");
$T="select * from  tbl_user_target_for_the_month where user_target_team_id='$team_id' and user_target_status='1' and user_target_month_id='$month'";
                             ...
                             ?>    <tr>
                                  ...
                                  echo    $name3=$row2['user_name'];
                                    ...
                                    <td>Rs.<?php echo $row['user_target_amount'];?></td>
                                                                           <td><?php 
 $total=0;
 $qs="SELECT enq_quotation  FROM `tbl_enquiry` where  `enq_year_id`='$yid' and `enq_status`='Completed' and `enq_alloted_to`='$name2' and `enq_month_id`='$month'";
...
while($acheived_array=mysqli_fetch_array($getaacheived)){
 ...
 $resultss= mysqli_query($conn, $qamount);
  ...
  $total+= $results['total'];
								...
								echo $total;	?></td>
                                      <td> <a href="view_target_list_team.php?id=<?php echo $id;?>" class="btn btn-info" title="view"><i class="icon-eye"></i></a>
									  <a href="edit_target_list_team.php?id=<?php echo $id;?>" class="btn btn-info" title="edit"><i class="icon-edit"></i></a>
									  </td>

        ...
        <div class="col-xs-12">
            <div class="card">
                ...
                <div class="card-body collapse in">
					...
					<form method="POST" id="reports-gen" action="enq_export_reports.php">
								...
								<div class="form-group row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <select id="enq_user" name="id" class="form-control">
																...
																<option value="2">New Reports</option>
																<option value="3">Pending Reports</option>
																<option value="4">Process Reports</option>
																<option value="5">Completed Reports</option>
																<option value="6">Dropped Reports</option>
                                                            </select>
                                                        </div>
                                                    </div>

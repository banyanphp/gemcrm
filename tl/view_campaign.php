...
$id=$_GET['id'];
$q=mysqli_query($conn,"select * from tbl_campaign where campaign_id='$id'");
$row=mysqli_fetch_array($q);

$cname=$row['campaign_title'];
$cdate1=$row['campaign_start_date'];

$cdate2=$row['campaign_end_date'];
$cdate=$cdate1;
$cdate.='-';
$cdate.=$cdate2;

$campaign_description=$row['campaign_description'];
$campaign_place=$row['campaign_place'];
                                    ...
                                    <div class="card-body collapse in">
                                        <div class="card-block">
                                            ...
                                            <form class="form form-horizontal" id="add_campaign_form" name="theform">
                                                <div class="form-body">
                                                    <h4 class="form-section"><i class="icon-head"></i> Edit Campaign</h4>
                                                    <div class="form-group row" >
                                                        <label class="col-md-3 label-control" > Name</label>
                                                        <div class="col-md-9">
                                                            <input type="text" id="cname" class="form-control" value="<?php echo $cname; ?>" name="fname" style="width:99%;">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row" >
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" id="cplace" class="form-control" value="<?php echo $campaign_place; ?>" name="Place" style="width:99%;">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row" >
                                                        ...
                                                        <div class="col-md-9">
                                                            <textarea name="description" id="description" class="form-control"><?php echo $campaign_description; ?></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card-body collapse in">
                                                        <div class="card-block form-group row">
                                                            ...
                                                            <div class="col-md-9" style="padding-left: 0px;"><div class='input-group'>
                                                                    <input type='text' placeholder="date" class="form-control daterange" id="from" name="date"  value="<?php echo $cdate; ?>"/>
                                                    ...
                                                    <div class="col-lg-12 mb-1" style="visibility: hidden;display:none;">
                                                        <div class="input-group">
                                                            ...
                                                            <input id="picker_from" class="datepicker" type="date" name="picker_from" value="<?php echo $cdate1; ?>"/>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12" style="visibility: hidden;display:none;">
                                                        <div class="input-group">
                                                            ...
                                                            <input id="picker_to" class="datepicker" type="hidden" name="picker_to"value="<?php echo $cdate2; ?>"/>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="select2 form-control block participants" name="participants" multiple="multiple" id="participants" style="width: 75%;margin-left:100px">
															...
															$s="select * from tbl_team_members where team_id='$team_id'";
															$q22=mysqli_query($conn,$s);
	while($row22=mysqli_fetch_array($q22)){
		$code=$row22['members_code'];
                                                            $q = mysqli_query($conn,"select * from tbl_user where user_code='$code'");
                                                            while ($row = mysqli_fetch_array($q)) {
																$d2="select * from tbl_campaign_participants where campaign_participants_code='$code'";
                                                               $q1= mysqli_query($conn,$d2);  
...
$r2=mysqli_fetch_array($q1);	
  ...
  ?>       
                                                                ...
                                                                <option value="<?php echo $row['user_code'] ?>" <?php 
																if($r2['campaign_participants_code']==$code) 
																{ 
															echo "selected";
															} 
															?>
															><?php echo $row['user_name']; ?>(<?php echo $row['user_code']; ?>)</option>
	<?php } } ?>
            ...
            options.template = '<div class="daterangepicker dropdown-menu">' +
                '<div class="calendar left">' +
                    '<div class="daterangepicker_input">' +
                      '<input class="input-mini form-control" type="text" name="daterangepicker_start" value="<?php echo $cdate1; ?>" />' +
                ...
                '<div class="calendar right">' +
                    '<div class="daterangepicker_input">' +
                      '<input class="input-mini form-control" type="text" name="daterangepicker_end" value="<?php echo $cdate1; ?>" />' +
                      '<i class="icon-calendar glyphicon glyphicon-calendar"></i>' +
                      '<div class="calendar-time">' +
                        '<div></div>' +
                        '<i class="icon-clock-o glyphicon glyphicon-time"></i>' +
...
! function(a, b, c) {
    ...
    var d = c("#picker_from").pickadate('<?php echo $cdate1;?>'),
        e = d.pickadate("picker"),
        f = c("#picker_to").pickadate('<?php echo $cdate2;?>'),
        g = f.pickadate("picker");
	
    e.get("value") && g.set("min", e.get("select")), g.get("value") && e.set("max", g.get("select")), e.on("set", function(a) {
        a.select ? g.set("min", e.get("select")) : "clear" in a && g.set("min", !1)
    }), g.on("set", function(a) {
        a.select ? e.set("max", g.get("select")) : "clear" in a && e.set("max", !1)
    }), c(".pickatime").pickatime(), c(".pickatime-button").pickatime({
        clear: ""
    }), c(".pickatime-format").pickatime({
        format: "T!ime selected: h:i a",
        formatLabel: "h:i a",
        formatSubmit: "HH:i",
        hiddenPrefix: "prefix__",
        hiddenSuffix: "__suffix"
    }), c(".pickatime-formatTime").pickatime({
        format: "T!ime selected: h:i a",
        formatLabel: "<b>h</b>:i <!i>a</!i>",
        formatSubmit: "HH:i",
        hiddenPrefix: "prefix__",
        hiddenSuffix: "__suffix"
    }), c(".pickatime-formatlabel").pickatime({
        formatLabel: function(a) {
            var b = (a.pick - this.get("now").pick) / 60,
                c = b < 0 ? " !hours to now" : b > 0 ? " !hours from now" : "now";
            return "h:i a <sm!all>" + (b ? Math.abs(b) : "") + c + "</sm!all>"
        }
    }), c(".pickatime-minmax").pickatime({
        min: new Date(2015, 3, 20, 7),
        max: new Date(2015, 7, 14, 18, 30)
    }), c(".pickatime-limits").pickatime({
        min: -5,
        max: !0
    }), c(".pickatime-intervals").pickatime({
        interval: 150
    }), c(".pickatime-disable").pickatime({
        disable: [new Date(2016, 3, 20, 4, 30), new Date(2016, 3, 20, 9)]
    }), c(".pickatime-disable-integer").pickatime({
        disable: [3, 5, 7, 13, 17, 21]
    }), c(".pickatime-disable-object").pickatime({
        disable: [{
            from: [2, 0],
            to: [5, 30]
        }]
    }), c(".pickatime-disable-all").pickatime({
        disable: [!0, 3, 5, 7, [0, 30],
            [2, 0],
            [8, 30],
            [9, 0]
        ]
    }), c(".pickatime-close-action").pickatime({
        closeOnSelect: !1,
        closeOnClear: !1
    }), c(".pickatime-events").pickatime({
        onStart: function() {
        ...
        onSet: function(a) {
            console.log("All stuff:", a)
        }
    }), c(".pickatime-translations").pickatime({
        ...
        clear: "clair",
        close: "Fermer"
    }), c(".daterange").daterangepicker(), c(".datetime").daterangepicker({
        timePicker: !0,
        timePickerIncrement: 30,
        locale: {
            format: "MM/DD/YYYY h:mm A"
        }
    }), c(".timeseconds").daterangepicker({
        timePicker: !0,
        timePickerIncrement: 30,
        timePicker24Hour: !0,
        timePickerSeconds: !0,
    ...
    }), c(".singledate").daterangepicker({
        singleDatePicker: !0,
        showDropdowns: !0
    }), c(".autoapply").daterangepicker({
        autoApply: !0
    }), c(".linkedCalendars").daterangepicker({
        linkedCalendars: !1
    }), c(".dateLimit").daterangepicker({
        dateLimit: {
            days: 7
        }
    }), c(".showdropdowns").daterangepicker({
        showDropdowns: !0
    }), c(".showweeknumbers").daterangepicker({
        showWeekNumbers: !0
    }), c(".dateranges").daterangepicker({
        ranges: {
            Today: [moment(), moment()],
    ...
    }), c(".shawCalRanges").daterangepicker({
        ranges: {
            Today: [moment(), moment()],
            Yesterday: [moment().subtract(1, "days"), moment().subtract(1, "days")],
            "Last 7 Days": [moment().subtract(6, "days"), moment()],
    ...
    }), c(".openRight").daterangepicker({
        opens: "left"
    }), c(".drops").daterangepicker({
        drops: "up"
    }), c(".buttonClass").daterangepicker({
        drops: "up",
        buttonClasses: "btn",
        applyClass: "btn-info",
        cancelClass: "btn-danger"
    }), c(".localeRange").daterangepicker({
        ranges: {

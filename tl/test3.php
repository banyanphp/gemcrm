...
$d=mysqli_fetch_array(mysqli_query($conn,$my));
 ...
 $da=$d['user_discount'];?>
												   ...
												   <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                         <input type="text" oncut="return false" onpaste="return false"  id="Discount" class="form-control" name="Discount" onKeyPress="return isNumberKey(event)"  onkeyup="this.value = minmax(this.value,<?php echo $da;?>)">
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="col-md-9">
                                                            <select id="shows_quotation_list" name="shows_quotation" class="form-control">
                                                                <option value="0">Select Quotation</option>
                                                                 <?php
                                                                $q4 = mysqli_query($conn, "select quotation_no,quotation_id from tbl_quotation where enq_no='$enq_no'");
                                                                while ($row4 = mysqli_fetch_array($q4)) {
                                                                    ?>                                                            
                                                                <option value="<?php echo $row4['quotation_no'];?>"><?php echo $row4['quotation_no'] ?></option>
<?php
                                                                }
?>
                                                            </select>

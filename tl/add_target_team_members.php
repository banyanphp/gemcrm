...
<section id="horizontal-form-layouts">
	...
	<div class="form-group row">
            <?php include 'dbconnect.php';$team_id = $_SESSION['team_id'];
...
<div class="form-group row">
                                            ...
                                            <div class=" col-md-9">
                                                        <select class="form-control"  name="team" id="team">
														  ...
														  while($rows=mysqli_fetch_array($qs)){
														  ?>
          <option value="<?php echo $rows['members_code']; ?>"><?php echo $rows['members_code']; ?></option>
														  <?php } ?>
														</select>

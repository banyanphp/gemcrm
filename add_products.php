	            ...
	            <div class="card-body collapse in">
	              ...
	              <div id="2KD" style="display:none" >
								...
								<div class="form-group row">
									...
									<div class="col-md-9">
		                            	<input type="text"  id="2kd_sapcode" class="form-control" placeholder="Enter Sapcode" name="kd_sapcode">
		                            </div>
		                        </div>
		                        <div class="form-group row">
	                            	<label class="col-md-3 label-control" for="projectinput2">Air Coolded R134a Price :</label>
									<div class="col-md-9">
	                            		<input type="text" id="2kdac_r134" class="form-control" placeholder="Enter Air Coolded R134a" name="2kdac_r134">
	                            	</div>
		                        </div>
		                        <div class="form-group row">
		                            <label class="col-md-3 label-control" for="projectinput3">Air Coolded R404c Price:</label>
		                            <div class="col-md-9">
		                            	<input type="text" id="2kdac_r404c" class="form-control" placeholder="Enter Air Coolded R404c" name="2kdac_r404c">
		                            </div>
		                        </div>
		                        ...
		                        <div class="form-group row">
									...
									<div class="col-md-9">
		                            	<input type="text" id="2kddelivery_terms" class="form-control" placeholder="Enter Delivery Times" name="2kddelivery_terms">
		                            </div>
		                        </div>
								    <div class="form-group row">
								...
								<div class="form-group row">
									...
									<div class="col-md-9">
		                            	<textarea type="text" name="kd_descrp" id="kd_descrp" rows="4" cols="121"class="form-control" placeholder="Enter Description" ></textarea>
		                            </div>
		                        </div>
								<!--<div class="form-group row">
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Sap code :</label>
									<div class="col-md-9">
		                            	<input type="text"  id="kw_sapcode" class="form-control" placeholder="Enter Sapcode" name="kw_sapcode">
		                            </div>
		                        </div>
		                        <div class="form-group row">
		                        ...
		                        <div class="form-group row">
		                            ...
		                            <div class="col-md-9">
		                            	<input type="text" id="2kw_wrk_pressure" class="form-control" placeholder="Enter Working Pressure :" name="kw_wrk_pressure">
		                            </div>
		                        </div>
		                        ...
		                        <div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Air Connection In/Out :</label>
									<div class="col-md-9">
		                            	<input type="text" id="2kw_ac_io" class="form-control" placeholder="Enter Air Connection In/Out" name="kw_ac_io">
		                            </div>
		                        </div>
		                        ...
		                        <div class="form-group row">
									...
									<div class="col-md-9">
		                            	<input type="text" id="2kw_pwr_cons" class="form-control" placeholder="Enter Power Consumption" name="kw_pwr_cons">
		                            </div>
		                        </div>
									...
									<div class="col-md-9">
		                            	<input type="text" id="2kw_delivery_times" class="form-control" placeholder="Enter Delivery Terms :" name="kw_delivery_times">
		                            </div>
		                        </div>
							<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Electrical Connection 230v/1s/50Hz :</label>
									<div class="col-md-9">
		                            	<input type="text" id="2kw_ec_230v" class="form-control" placeholder="Enter Electrical Connection 230v/1s/50Hz" name="kw_ec_230v">
		                            </div>
		                        </div>
		                        <div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Electrical Connection 415v/3s/50Hz :</label>
									<div class="col-md-9">
		                            	<input type="text" id="2kw_ec_415v" class="form-control" placeholder="Enter Electrical Connection 415v/3s/50Hz" name="kw_ec_415v">
		                            </div>
		                        </div>
								    <div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Warranty Date Of Commission :</label>
									<div class="col-md-9">
		                            	<input type="text" id="2kw_warnty_doc" class="form-control" placeholder="Enter Warranty Date Of Commission" name="kw_warnty_doc">
		                            </div>
		                        </div>
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Warrenty Date Of Invoice :</label>
									<div class="col-md-9">
		                            	<input type="text" id="2kw_warnty_doi" class="form-control" placeholder="Enter Warrenty Date Of Invoice" name="kw_warnty_doi">
		                            </div>
		                        </div>
		                        <div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Weight :</label>
									<div class="col-md-9">
		                            	<input type="text" id="2kw_weght" class="form-control" placeholder="Enter Product Weight" name="kw_weght">
		                            </div>
		                        </div>
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Descripition :</label>
									<div class="col-md-9">
		                            	<textarea type="text" name="kw_descrp" id="kw_descrp" rows="4" cols="121"class="form-control" placeholder="Enter Description" ></textarea>
		                            </div>
		                        </div>
								<!--<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Discount :</label>
							...
							<div class="form-group row">
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Sap code :</label>
									<div class="col-md-9">
		                            	<input type="text"  id="acc_sapcode" class="form-control" placeholder="Enter Sapcode" name="acc_sapcode">
		                            </div>
		                        </div>
		                        <div class="form-group row">
							...
							<div class="form-group row">
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Descripition :</label>
									<div class="col-md-9">
		                            	<textarea type="text" name="acc_descrp" id="acc_descrp" rows="4" cols="121"class="form-control" placeholder="Enter Description" ></textarea>
		                            </div>
		                        </div>
								<!--<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Discount :</label>
							...
							<div class="form-group row">
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Sap code :</label>
									<div class="col-md-9">
		                            	<input type="text"  id="at_sapcode" class="form-control" placeholder="Enter Sapcode" name="at_sapcode">
		                            </div>
		                        </div>
		                        <div class="form-group row">
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Descripition :</label>
									<div class="col-md-9">
		                            	<textarea type="text" name="at_descrp" id="at_descrp" rows="4" cols="121"class="form-control" placeholder="Enter Description" ></textarea>
		                            </div>
		                        </div>
									<!--<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Discount :</label>
								...
								<div class="form-group row">
									...
									<label class="col-md-3 label-control" for="projectinput5">Sap code :</label>
									<div class="col-md-9">
		                            	<input type="text"  id="cht_sapcode" class="form-control" placeholder="Enter Sapcode" name="cht_sapcode">
		                            </div>
		                        </div>
		                        <div class="form-group row">
		                        ...
		                        <div class="form-group row">
									...
									<div class="col-md-9">
		                            	<input type="text" id="cht_heat" class="form-control" placeholder="Heat Load Kcal/h" name="cht_heat">
		                            </div>
		                        </div>
							...
							<div class="form-group row">
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Descripition :</label>
									<div class="col-md-9">
		                            	<textarea type="text" name="cht_descrp" id="cht_descrp" rows="4" cols="121"class="form-control" placeholder="Enter Description" ></textarea>
		                            </div>
		                        </div>
								<!--<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5"> Discount :</label>
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Sap code :</label>
									<div class="col-md-9">
		                            	<input type="text"  id="nxtgen_hh_sapcode" class="form-control" placeholder="Enter Sapcode" name="nxtgen_hh_sapcode">
		                            </div>
		                        </div>
		                        <div class="form-group row">
							...
							<div class="form-group row">
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Descripition :</label>
									<div class="col-md-9">
		                            	<textarea type="text" name="nxtgen_hh_descrp" id="nxtgen_hh_descrp" rows="4" cols="121"class="form-control" placeholder="Enter Description" ></textarea>
		                            </div>
		                        </div>
								<!--<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5"> Discount :</label>
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Sap code :</label>
									<div class="col-md-9">
		                            	<input type="text" id="cht_nexlh_sapcode" class="form-control" placeholder="Enter Sapcode" name="cht_lh_sapcode">
		                            </div>
		                        </div>
		                        <div class="form-group row">
							...
							<div class="form-group row">
		                        ...
		                        <div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Delivery Terms</label>
									<div class="col-md-9">
		                            	<input type="text" id="cht_nexlh_delivr" class="form-control" placeholder="Delivery Terms" name="cht_nexlh_delivr">
		                            </div>
		                        </div>
								    <div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Warranty Date Of Commission :</label>
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Descripition :</label>
									<div class="col-md-9">
		                            	<textarea type="text" name="cht_nexlh_descrp" id="cht_nexlh_descrp" rows="4" cols="121"class="form-control" placeholder="Enter Description" ></textarea>
		                            </div>
		                        </div>
								<!--<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5"> Discount :</label>
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Sap code :</label>
									<div class="col-md-9">
		                            	<input type="text" id="dct_sapcode" class="form-control" placeholder="Enter Sapcode" name="dct_sapcode">
		                            </div>
		                        </div>
		                        <div class="form-group row">
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Descripition :</label>
									<div class="col-md-9">
		                            	<textarea type="text" name="dct_descrp" id="dct_descrp"  rows="4" cols="121"class="form-control" placeholder="Enter Description" ></textarea>
		                            </div>
		                        </div>
								<!--<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5"> Discount :</label>
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Sap code :</label>
									<div class="col-md-9">
		                            	<input type="text" id="ect_sapcode" class="form-control" placeholder="Enter Sapcode" name="ect_sapcode">
		                            </div>
		                        </div>
		                        <div class="form-group row">
								...
								<div class="form-group row">
									...
									<div class="col-md-9">
		                            	<input type="text" id="ect_war_io" class="form-control" placeholder="Enter Warranty Date Of Invoice" name="ect_war_io">
		                            </div>
		                        </div>
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Weight :</label>
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Descripition :</label>
									<div class="col-md-9">
		                            	<textarea type="text" name="ect_descrp" id="ect_descrp" rows="4" cols="121"class="form-control" placeholder="Enter Description" ></textarea>
		                            </div>
		                        </div>
								    <!--<div class="form-group row">
								...
								<input type="hidden" name="action" value="gas" >
									...
									<label class="col-md-3 label-control" for="projectinput5">Sap code :</label>
									<div class="col-md-9">
		                            	<input type="text"  id="gas_sapcode" class="form-control" placeholder="Enter Sapcode" name="gas_sapcode">
		                            </div>
		                        </div>
		                        <div class="form-group row">
							...
							<div class="form-group row">
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Descripition :</label>
									<div class="col-md-9">
		                            	<textarea type="text" name="gas_descrp" id="gas_descrp" rows="4" cols="121"class="form-control" placeholder="Enter Description" ></textarea>
		                            </div>
		                        </div>
								<!--<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5"> Discount :</label>
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Sap code :</label>
									<div class="col-md-9">
		                            	<input type="text" id="gcteco_sapcode" class="form-control" placeholder="Enter Sapcode" name="gcteco_sapcode">
		                            </div>
		                        </div>
		                        <div class="form-group row">
							...
							<div class="form-group row">
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Descripition :</label>
									<div class="col-md-9">
		                            	<textarea type="text" name="gcteco_descrp" id="gcteco_descrp" rows="4" cols="121"class="form-control" placeholder="Enter Description" ></textarea>
		                            </div>
		                        </div>
								<!--<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5"> Discount :</label>
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Sap code :</label>
									<div class="col-md-9">
		                            	<input type="text" id="gzff_sapcode" class="form-control" placeholder="Enter Sapcode" name="gzff_sapcode">
		                            </div>
		                        </div>
		                        <div class="form-group row">
							...
							<div class="form-group row">
		                        ...
		                        <div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Warranty Date Of Commission :</label>
									<div class="col-md-9">
		                            	<input type="text" id="gzf_warnty_doc" class="form-control" placeholder="Enter Warranty Date Of Commission " name="gzf_warenty_doc">
		                            </div>
		                        </div>
								    <div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Warranty Date Of Invoice :</label>
									<div class="col-md-9">
		                            	<input type="text" id="gzf_warnty_doi" class="form-control" placeholder="Enter Warranty Date Of Invoice" name="gzf_warenty_doi">
		                            </div>
		                        </div>
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Working presssure :</label>
									<div class="col-md-9">
		                            	<input type="text" id="gzf_wrk_press" class="form-control" placeholder="Enter Warranty Date Of Invoice" name="gzf_wrk_press">
		                            </div>
		                        </div>
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Weight :</label>
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Descripition :</label>
									<div class="col-md-9">
		                            	<textarea type="text" name="gzff_descrp" id="gzff_descrp" rows="4" cols="121"class="form-control" placeholder="Enter Description" ></textarea>
		                            </div>
		                        </div>
								<!--<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5"> Discount :</label>
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Sap code :</label>
									<div class="col-md-9">
		                            	<input type="text" id="gzfcat_sapcode" class="form-control" placeholder="Enter Sapcode" name="gzfcat_sapcode">
		                            </div>
		                        </div>
		                        <div class="form-group row">
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Descripition :</label>
									<div class="col-md-9">
		                            	<textarea type="text" name="gzfcat_descrp" id="gzfcat_descrp" rows="4" cols="121"class="form-control" placeholder="Enter Description" ></textarea>
		                            </div>
		                        </div>
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Sap code :</label>
									<div class="col-md-9">
		                            	<input type="text" id="hld_sapcode" class="form-control" placeholder="Enter Sapcode" name="hld_sapcode">
		                            </div>
		                        </div>
		                        <div class="form-group row">
		                        ...
		                        <div class="form-group row">
									...
									<label class="col-md-3 label-control" for="projectinput5">Working Pressure :</label>
									<div class="col-md-9">
		                            	<input type="text" id="hld_wrkngpres" class="form-control" placeholder="Enter Working Pressure" name="hld_wrkngpres">
		                            </div>
		                        </div>
		                        <div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Warranty Date Of Commission :</label>
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Descripition :</label>
									<div class="col-md-9">
		                            	<textarea type="text" name="hld_descrp" id="hld_descrp" rows="4" cols="121"class="form-control" placeholder="Enter Description" ></textarea>
		                            </div>
		                        </div>
						...
						<!-- span  hln -->
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Sap code :</label>
									<div class="col-md-9">
		                            	<input type="text" id="hln_sapcode" class="form-control" placeholder="Enter Sapcode" name="hln_sapcode">
		                            </div>
		                        </div>
		                        <div class="form-group row">
	                            	<label class="col-md-3 label-control" for="projectinput2"><strong>Desiccant Activated Alumina(50&deg;c)</strong><br>IS2825 code of Construction Price :</label>
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Descripition :</label>
									<div class="col-md-9">
		                            	<textarea type="text" name="hln_descrp" id="hln_descrp" rows="4" cols="121"class="form-control" placeholder="Enter Description" ></textarea>
		                            </div>
		                        </div>
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Sap code :</label>
									<div class="col-md-9">
		                            	<input type="text"  id="hp_sapcode" class="form-control" placeholder="Enter Sapcode" name="hp_sapcode">
		                            </div>
		                        </div>
		                        <div class="form-group row">
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Descripition :</label>
									<div class="col-md-9">
		                            	<textarea type="text" name="hp_descrp" id="hp_descrp" rows="4" cols="121"class="form-control" placeholder="Enter Description" ></textarea>
		                            </div>
		                        </div>
								</div>
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Sap code :</label>
									<div class="col-md-9">
		                            	<input type="text"  id="hp_ele_sapcode" class="form-control" placeholder="Enter Sapcode" name="hp_ele_sapcode">
		                            </div>
		                        </div>
		                        <div class="form-group row">
								...
								<div class="form-group row">
									...
									<label class="col-md-3 label-control" for="projectinput5">Descripition :</label>
									<div class="col-md-9">
		                            	<textarea type="text" name="hp_ele_descrp" id="hp_ele_descrp" rows="4" cols="121"class="form-control" placeholder="Enter Description" ></textarea>
		                            </div>
		                        </div>
								</div>
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Sap code :</label>
									<div class="col-md-9">
		                            	<input type="text" id="mst_sapcode" class="form-control" placeholder="Enter Sapcode" name="mst_sapcode">
		                            </div>
		                        </div>
		                        <div class="form-group row">
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Descripition :</label>
									<div class="col-md-9">
		                            	<textarea type="text" name="mst_descrp" id="mst_descrp" rows="4" cols="121"class="form-control" placeholder="Enter Description" ></textarea>
		                            </div>
		                        </div>
								</div>
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Sap code :</label>
									<div class="col-md-9">
		                            	<input type="text" id="nxg_sapcode" class="form-control" placeholder="Enter Sapcode" name="nxg_sapcode">
		                            </div>
		                        </div>
		                        <div class="form-group row">
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Descripition :</label>
									<div class="col-md-9">
		                            	<textarea type="text" name="nxg_descrp" id="nxg_descrp" rows="4" cols="121"class="form-control" placeholder="Enter Description" ></textarea>
		                            </div>
		                        </div>
								</div>
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Sap code :</label>
									<div class="col-md-9">
		                            	<input type="text" id="rad_sapcode" class="form-control" placeholder="Enter Sapcode" name="rad_sapcode">
		                            </div>
		                        </div>
		                        <div class="form-group row">
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Descripition :</label>
									<div class="col-md-9">
		                            	<textarea type="text" name="rad_descrp" id="rad_descrp" rows="4" cols="121"class="form-control" placeholder="Enter Description" ></textarea>
		                            </div>
		                        </div>
								</div>
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Sap code :</label>
									<div class="col-md-9">
		                            	<input type="text"  id="scb_sapcode" class="form-control" placeholder="Enter Sapcode" name="scb_sapcode">
		                            </div>
		                        </div>
		                        <div class="form-group row">
								...
								<div class="form-group row">
									...
									<label class="col-md-3 label-control" for="projectinput5">Descripition :</label>
									<div class="col-md-9">
		                            	<textarea type="text" name="scb_descrp" id="scb_descrp" rows="4" cols="121"class="form-control" placeholder="Enter Description" ></textarea>
		                            </div>
		                        </div>
								</div>
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Sap code :</label>
									<div class="col-md-9">
		                            	<input type="text"  id="sct_sapcode" class="form-control" placeholder="Enter Sapcode" name="sct_sapcode">
		                            </div>
		                        </div>
		                        <div class="form-group row">
								...
								<div class="form-group row">
									...
									<label class="col-md-3 label-control" for="projectinput5">Descripition :</label>
									<div class="col-md-9">
		                            	<textarea type="text" name="sct_descrp" id="sct_descrp" rows="4" cols="121"class="form-control" placeholder="Enter Description" ></textarea>
		                            </div>
		                        </div>
								</div>
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Sap code :</label>
									<div class="col-md-9">
		                            	<input type="text" id="spd_sapcode" class="form-control" placeholder="Enter Sapcode" name="spd_sapcode">
		                            </div>
		                        </div>
		                        <div class="form-group row">
		                        ...
		                        <div class="form-group row">
		                            ...
		                            <div class="col-md-9">
		                            	<input type="text" id="spd_wrkprs" class="form-control" placeholder="Enter Work Space" name="spd_wrkprs">
		                            </div>
		                        </div>
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Weight :</label>
									...
									<label class="col-md-3 label-control" for="projectinput5">Descripition :</label>
									<div class="col-md-9">
		                            	<textarea type="text" name="spd_descrp" id="spd_descrp" rows="4" cols="121"class="form-control" placeholder="Enter Description" ></textarea>
		                            </div>
		                        </div>
								</div>
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Sap code :</label>
									<div class="col-md-9">
		                            	<input type="text"  id="var_sapcode" class="form-control" placeholder="Enter Sapcode" name="var_sapcode">
		                            </div>
		                        </div>
		                        <div class="form-group row">
	                            	<label class="col-md-3 label-control" for="projectinput2">Model Variance :</label>
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Descripition :</label>
									<div class="col-md-9">
		                            	<textarea type="text" name="var_descrp" id="var_descrp"  rows="4" cols="121"class="form-control" placeholder="Enter Description" ></textarea>
		                            </div>
		                        </div>
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Sap code :</label>
									<div class="col-md-9">
		                            	<input type="text"   id="vxs_sapcode" class="form-control" placeholder="Enter Sapcode" name="vxs_sapcode">
		                            </div>
		                        </div>
		                        <div class="form-group row">
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Descripition :</label>
									<div class="col-md-9">
		                            	<textarea type="text" name="vxs_descrp" id="vxs_descrp" rows="4" cols="121"class="form-control" placeholder="Enter Description" ></textarea>
		                            </div>
		                        </div>
								</div>
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Sap code :</label>
									<div class="col-md-9">
		                            	<input type="text"  id="wah_sapcode" class="form-control" placeholder="Enter Sapcode" name="wah_sapcode">
		                            </div>
		                        </div>
		                        <div class="form-group row">
		                        ...
		                        <div class="form-group row">
		                            ...
		                            <div class="col-md-9">
		                            	<input type="text" id="wah_capacity" class="form-control" placeholder="Enter Capacity Cfm" name="wah_capacty">
		                            </div>
		                        </div>
								<div class="form-group row">
								...
								<div class="form-group row">
		                            ...
		                            <div class="col-md-9">
		                            	<input type="text" id="wah_shelldia" class="form-control" placeholder="Enter Shell dia" name="wah_sheldia">
		                            </div>
		                        </div>
								<div class="form-group row">
		                            <label class="col-md-3 label-control" for="projectinput3">Delivery Terms :</label>
			                    ...
			                    <div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Descripition :</label>
									<div class="col-md-9">
		                            	<textarea type="text" name="wah_descrp" id="wah_descrp" rows="4" cols="121"class="form-control" placeholder="Enter Description" ></textarea>
		                            </div>
		                        </div>
								</div>
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Sap code :</label>
									<div class="col-md-9">
		                            	<input type="text"  id="gz_sapcode" class="form-control" placeholder="Enter Sapcode" name="gz_sapcode">
		                            </div>
		                        </div>
		                        <div class="form-group row">
	                            	<label class="col-md-3 label-control" for="projectinput2"> Price :</label>
								...
								<div class="form-group row">
		                            ...
		                            <div class="col-md-9">
		                            	<input type="text" id="gz_inout_port" class="form-control" placeholder="Enter Input/Output ports" name="gz_inout_port">
		                            </div>
		                        </div>
		                        <div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Warranty Date Of Commission :</label>
								...
								<div class="form-group row">
									...
									<label class="col-md-3 label-control" for="projectinput5">Descripition :</label>
									<div class="col-md-9">
		                            	<textarea type="text" name="gz_descrp" id="gz_descrp" rows="4" cols="121"class="form-control" placeholder="Enter Description" ></textarea>
		                            </div>
		                        </div>
								</div>
			                    ...
			                    <div class="form-group row">
	                            	<label class="col-md-3 label-control" for="projectinput1">Product Model :</label>
		                            <div class="col-md-9">
		                            	<input type="text" id="gv_prd_model" class="form-control" placeholder="Enter Product Model" name="gzf_prd_model">
		                            </div>
		                        </div>
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Sap code :</label>
									<div class="col-md-9">
		                            	<input type="text"  id="gzf_sapcode" class="form-control" placeholder="Enter Sapcode" name="gzf_sapcode">
		                            </div>
		                        </div>
		                        <div class="form-group row">
	                            	<label class="col-md-3 label-control" for="projectinput2"> Price :</label>
								...
								<div class="form-group row">
		                            <label class="col-md-3 label-control" for="projectinput3">Power consumption :</label>
		                            <div class="col-md-9">
		                            	<input type="text" id="gzf_pwrcon" class="form-control" placeholder="Enter Cooling Water in/out" name="gzf_pwrcon">
		                            </div>
		                        </div>
								<div class="form-group row">
		                            <label class="col-md-3 label-control" for="projectinput3">Max operating Temperature:</label>
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Weight :</label>
									<div class="col-md-9">
		                            	<input type="text" id="gzf_wght" class="form-control" placeholder="Enter Product Weight" name="gzf_wght">
		                            </div>
		                        </div>
									...
									<label class="col-md-3 label-control" for="projectinput5">Descripition :</label>
									<div class="col-md-9">
		                            	<textarea type="text" name="gzf_descrp" id="gzf_descrp" rows="4" cols="121"class="form-control" placeholder="Enter Description" ></textarea>
		                            </div>
		                        </div>
								</div>
								...
								<!-- 2kd7 -->
								  <div id="2KD7" style="display:none" >
								<input type="hidden" name="2kd_action">
								
								  	<div class="form-group row">
	                            	<label class="col-md-3 label-control" for="projectinput1">Product Model :</label>
		                            <div class="col-md-9">
		                            	<input type="text" value="" id="kd7_prd_model" class="form-control" placeholder="Enter Product Model" name="kd7_prd_model">
		                            </div>
		                        </div>
								...
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Sap code :</label>
									<div class="col-md-9">
		                            	<input type="text"  id="kd7_sapcode" class="form-control" placeholder="Enter Sapcode" name="kd7_sapcode">
		                            </div>
		                        </div>
		                        <div class="form-group row">
	                            	<label class="col-md-3 label-control" for="projectinput2">Air Cooled R134a Pirce :</label>
									<div class="col-md-9">
	                            		<input type="text" id="kd7_ac_r134" class="form-control" placeholder="Enter Air Cooled R134a Price" name="kd7_ac_r134">
	                            	</div>
		                        </div>
		                        ...
		                        <div class="form-group row">
		                            <label class="col-md-3 label-control" for="projectinput3">Capacity :</label>
		                            <div class="col-md-9">
		                            	<input type="text"  id="kd7_cap" class="form-control" placeholder="Enter Capacity" name="kd7_cap">
		                            </div>
		                        </div>
		                        ...
		                        <div class="form-group row">
		                            <label class="col-md-3 label-control" for="projectinput4">Working Pressure :</label>
		                            <div class="col-md-9">
		                            	<input type="text"  id="kd7_wrk_pressure" class="form-control" placeholder="Enter Working Pressure :" name="kd7_wrk_pressure">
		                            </div>
		                        </div>
		                        ...
		                        <div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Air Connection In/Out :</label>
									<div class="col-md-9">
		                            	<input type="text"  id="kd7_ac_io" class="form-control" placeholder="Enter Air Connection In/Out" name="kd7_ac_io">
		                            </div>
		                        </div>
		                        ...
		                        <div class="form-group row">
									...
									<div class="col-md-9">
		                            	<input type="text"  id="kd7_pwr_cons" class="form-control" placeholder="Enter Rate Power" name="kd7_pwr_cons">
		                            </div>
		                        </div>
									...
									<label class="col-md-3 label-control" for="projectinput5">Delivery Terms :</label>
									<div class="col-md-9">
		                            	<input type="text"  id="kd7_delivery_times" class="form-control" placeholder="Enter Delivery Terms :" name="kd7_delivery_times">
		                            </div>
		                        </div>
							<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Electrical Connection 230v/1s/50Hz :</label>
									<div class="col-md-9">
		                            	<input type="text"  id="kd7_ec_230v" class="form-control" placeholder="Enter Electrical Connection 230v/1s/50Hz" name="kd7_ec_230v">
		                            </div>
		                        </div>
		                        <div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Electrical Connection 415v/3s/50Hz :</label>
									<div class="col-md-9">
		                            	<input type="text" id="kd7_ec_415v" class="form-control" placeholder="Enter Electrical Connection 415v/3s/50Hz" name="kd7_ec_415v">
		                            </div>
		                        </div>
								    <div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Warranty Date Of Commission :</label>
									<div class="col-md-9">
		                            	<input type="text" id="kd7_warnty_doc" class="form-control" placeholder="Enter Warranty Date Of Commission" name="kd7_warnty_doc">
		                            </div>
		                        </div>
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Warrenty Date Of Invoice :</label>
									<div class="col-md-9">
		                            	<input type="text" id="kd7_warnty_doi" class="form-control" placeholder="Enter Warrenty Date Of Invoice" name="kd7_warnty_doi">
		                            </div>
		                        </div>
		                        <div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Weight :</label>
									<div class="col-md-9">
		                            	<input type="text" id="kd7_weght" class="form-control" placeholder="Enter Product Weight" name="kd7_weght">
		                            </div>
		                        </div>
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Air inlet temperature :</label>
									<div class="col-md-9">
		                            	<input type="text" id="kd7_air" class="form-control" placeholder="Enter Air inlet temperature" name="kd7_air">
		                            </div>
		                        </div>
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Dew point :</label>
									<div class="col-md-9">
		                            	<input type="text" id="kd7_dew" class="form-control" placeholder="Enter Dew point" name="kd7_dew">
		                            </div>
		                        </div>
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Ambient Temperature :</label>
									<div class="col-md-9">
		                            	<input type="text" id="kd7_ambient" class="form-control" placeholder="Enter Ambient Temperature" name="kd7_ambient">
		                            </div>
		                        </div>
								<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Descripition :</label>
									<div class="col-md-9">
		                            	<textarea type="text"  name="kd7_descrp" id="kd7_descrp" value="<?php echo $row28['description']; ?>" rows="4" cols="121"class="form-control" placeholder="Enter Description" ></textarea>
		                            </div>
		                        </div>
								<!--<div class="form-group row">
									<label class="col-md-3 label-control" for="projectinput5">Discount :</label>

...
<section id="file-export">
  ...
  <?php
										...
										{echo 'Appointment fixed successfuly';}
											elseif($_SESSION['msg']='fail'){
												echo 'Error Occured please contact your Service Provider';} 
unset($_SESSION['msg']);
                        ...
                        <table class="table table-striped table-bordered file-export">
                            ...
                            <tbody>
							   ...
							   $date = date('Y-m-d');
								...
								$sql=mysqli_query($conn,"SELECT * FROM `tbl_appointment` WHERE appointment_date <= $date AND  appointment_user_code='$usr'");
							   ...
							   ?>
                                ...
                                <tr>
									...
									<a class="btn btn-default" href="appointmen_edit.php?id=<?php echo $id; ?>">  <i class="icon-trash-o" style="color:red;"></i> </a>
									</td>

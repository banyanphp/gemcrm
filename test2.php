...
<html lang="en" data-textdirection="LTR" class="loading">
    <head>
        ...
        <!-- END Page Level CSS-->
        <!-- BEGIN Custom CSS-->
        <link rel="stylesheet" type="text/css" href="robust-assets/css/style.css">
 ...
 <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <label class="col-md-3 label-control" for="projectinput7">Packaging & Forwarding Tax</label>
													 <div class="col-md-9">
                                                        <input type="text" oncut="return false" onpaste="return false" maxlength="2" id="tax" class="form-control" name="tax" placeholder="Enter packaging tax" onKeyPress="return isNumberKey(event)">
												...
												<div class="form-group row">
                                                    <label class="col-md-3 label-control" for="projectinput7">VAT/CST Tax</label>
													 <div class="col-md-9">
                                                        <input type="text" oncut="return false" onpaste="return false" maxlength="2" id="vat_tax" class="form-control" name="vat_tax" placeholder="Enter VAT/CST tax" onKeyPress="return isNumberKey(event)">
												...
												<div class="form-group row">
                                                    <label class="col-md-3 label-control" for="projectinput7">Excise Duty</label>
													 <div class="col-md-9">
                                                        <input type="text" oncut="return false" onpaste="return false" maxlength="2" id="exc_tax" class="form-control" name="exc_tax" placeholder="Enter Excise Duty" onKeyPress="return isNumberKey(event)">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" oncut="return false" onpaste="return false" maxlength="2" id="Discount" class="form-control" name="Discount" onKeyPress="return isNumberKey(event)"  onkeyup="this.value = minmax(this.value)">
